#!/usr/bin/env python3
"""Compact model-router segment for a Claude Code statusline.

Prints one short line like `router $0.03/$1.20 saved` (session/lifetime),
...
def main():
    ...
    if args.session:
        ...
        print(f"router ${session:.2f}/${total:.2f} saved")
    else:
        print(f"router ${total:.2f} saved")
